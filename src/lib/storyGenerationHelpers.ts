...
const WORLD_STORY_PAGE_PROMPTS: Record<StoryWorldKey, WorldStoryPagePrompts> = {
  ...
  outerspace: {
    tempMainStoryPagePrompt:
      "Replace the main boy character of template background image with the character of reference character image keeping the appearance of the reference image character. The replaced character should precisely match the pose, action, and emotions of the original boy main character in the template background image. All other characters and elements from the template background image must be kept and integrated seamlessly. Integrate the new main character into the template background image, ensuring lighting and style are perfectly blended. Generate the final image in stunning 4K resolution with an aspect ratio of 3:2 (width:height).",
    tempMainStoryPageAllyCharacterPrompt: "Kept the dophin ally character of template image.",
    ...
    pageAllyCharacterPrompts: {
      1: "Ally character - ally character should be not in this image.",
      2: "Ally character - ally character should be not removed, replaced and modified in this image.",//"Ally character of template background image must be replaced with [ally_name] character",
      3: "Ally character - ally character should be not removed, replaced and modified in this image.",// " Ally character of template background image must be replaced with [ally_name] character",
      4: "Ally character - ally character should be not removed, replaced and modified in this image.",//" Ally character of template background image must be replaced with [ally_name] character",
  ...
  underwater: {
    tempMainStoryPagePrompt:
      "Replace the main girl character of template background image with the character of reference character image keeping the appearance of the reference image character. The replaced character should precisely match the pose, action, and emotions of the original girl main character of the template background image. All other characters and elements from the template background image must be kept and integrated seamlessly. Integrate the new main character of reference character image into the underwater kingdom template background image (coral, bioluminescence, clear water), ensuring lighting and style are perfectly blended. Generate the final image in stunning 4K resolution with an aspect ratio of 3:2 (width:height).",
    tempMainStoryPageAllyCharacterPrompt: "Kept the dophin ally character of template image.",
    ...
    pageAllyCharacterPrompts: {
      1: "Ally character - ally character should be not removed, replaced and modified in this image. ",//"Ally character of template background image must be replaced with [ally_name] character",
      2: "Ally character - ally character should be not removed, replaced and modified in this image. ",//"Ally character of template background image must be replaced with [ally_name] character",
      3: "Ally character - ally character should be not removed, replaced and modified in this image. ",//"Ally character of template background image must be replaced with [ally_name] character",
      4: "Ally character - ally character should be not removed, replaced and modified in this image. ",//"Ally character of template background image must be replaced with [ally_name] character",
      5: "Ally character - ally character should be not removed, replaced and modified in this image. "//"Ally character of template background image must be replaced with [ally_name] character"
