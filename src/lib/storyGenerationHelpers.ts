...
const STORY_STYLE_WORLD_PAGE_PROMPTS: Record<StoryStyleKey, Record<StoryWorldKey, WorldStoryPagePrompts>> = {
  ...
  anime: {
    forest: {
      ...
      pageMainCharacterPoseActionEmotionPrompts: {
        1: "Anime style. The main character stands alone inside a dim moonlit wooden room, near a window with flowing curtains and cool blue shadows on the floor. The main character has a thoughtful, slightly serious expression, with one hand resting near the chin as if planning the journey. Keep the main character slightly left of center on reader's perspective. Ally character should not appear in this page.",
        2: "Anime style. In an enchanted night forest, the adventurous character stands with an excited smile and points forward with one hand as if discovering a clue. The fox ally companion stands close beside the character and looks up with curiosity. Place both slightly left of center, with the fox companion on the right from reader perspective.",
        3: "Anime style. On a forest path during a sudden burst of magical danger, the character takes a defensive action pose while holding a sword, with a focused and determined face. A bright explosion of light appears behind them, and the fox companion stays close near the character's side. Keep both slightly left of center, with the fox on the right from reader perspective.",
        4: "Anime style. The character walks forward confidently in front of a wooden forest cabin or shed, showing calm determination after the action moment. The fox companion walks close beside the character with alert but friendly energy. Place both slightly left of center, with the fox companion on the left from reader perspective.",
        5: "Anime style. At the open gates of a magical castle at night, the character shows joyful relief and celebration. The character raises a hand to high-five the happy fox companion as they arrive at the destination. Keep both slightly left of center, with the fox companion on the left from reader perspective and the castle visible in the background."
      }
    },
    outerspace: {
      tempMainStoryPagePrompt:
        "Replace the main boy character of template background image with the character of reference character image keeping the appearance of the reference image character. When replacing and integrating, the pose of emotions of the character of reference character image must be not kept. The replaced character should precisely match the pose, action, appearance (facial and body features), emotions, scale and size and height of the original boy main character of the template background image. All other characters and elements from the template background image must be kept and integrated seamlessly. The background of template image must be kept - never changed. Render in cinematic anime sci-fi style with clean linework, luminous highlights, and dramatic but child-friendly color contrast. Generate the final image in stunning 4K resolution with an aspect ratio of 3:2 (width:height).",
  ...
  cartoon: {
    forest: {
      tempMainStoryPagePrompt:
        "Replace the main girl/boy character of template background image with the character of reference character image keeping the appearance of the reference image character. When replacing and integrating, the pose of emotions of the character of reference character image must be not kept. The replaced character should precisely match the pose, action, appearance (facial and body features), emotions, scale and size and height of the original girl/boy main character of the template background image. All other characters and elements from the template background image must be kept and integrated seamlessly. The background of template image must be kept - never changed. Render in colorful cartoon storybook style with soft outlines, rounded forms, and bright kid-friendly tones. Generate the final image in stunning 4K resolution with an aspect ratio of 3:2 (width:height).",
      tempMainStoryPageAllyCharacterPrompt: "Keep the ally character from the template image. Do not remove or redesign it.",
      pageAllyCharacterPrompts: {
        1: "Ally character - ally character should be not in this image.",
        2: "Ally character - ally character should be not removed in this image.",
    ...
    outerspace: {
      tempMainStoryPagePrompt:
        "Replace the main boy character of template background image with the character of reference character image keeping the appearance of the reference image character. When replacing and integrating, the pose of emotions of the character of reference character image must be not kept. The replaced character should precisely match the pose, action, appearance (facial and body features), emotions, scale and size and height of the original boy main character of the template background image. All other characters and elements from the template background image must be kept and integrated seamlessly. The background of template image must be kept - never changed. Render in playful cartoon sci-fi style with clean shapes, vibrant neon colors, and readable expressions for children. Generate the final image in stunning 4K resolution with an aspect ratio of 3:2 (width:height).",
      tempMainStoryPageAllyCharacterPrompt: "Keep the ally character from the template image. Do not remove, replace, or redesign it.",
      pageAllyCharacterPrompts: {
        1: "Ally character - ally character should be not in this image.",
        2: "Ally character - ally character should be not removed, replaced and modified in this image.",
