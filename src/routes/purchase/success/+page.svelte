    ...
    async function sendPaymentEmails(sessionData: any) {
        ...
        try {
            ...
            const receiptResult = await sendReceiptEmail(
                ...
                [{
                    name: sessionData.purchase_type === 'story_bundle' 
                        ? 'Story Bundle'
                        : 'Single Story',
            ...
            if (urlStoryId) {
                ...
                if (urlSceneIndex) {
                    ...
                    try {
                        ...
                        console.log(`[purchase/success] Restored scene index ${urlSceneIndex} to sessionStorage for story ${savedStoryId}`);
                    } catch (error) {
                    ...
                    try {
                        ...
                        if (storedIndex) {
                            ...
                            console.log(`[purchase/success] Found scene index in sessionStorage: ${savedSceneIndex}`);
                        }
                    } catch (error) {
